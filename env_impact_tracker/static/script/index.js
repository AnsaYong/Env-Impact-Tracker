...
function createBarChart(label_set, data_set) {
    const bar1Ctx = document.getElementById('bar1Chart').getContext('2d');
    new Chart(bar1Ctx, {
        type: 'bar',
        data: {
            labels: label_set,
    ...
    document.getElementById('bar1Chart').style.backgroundColor = 'rgba(255, 255, 255, 1)';
}


//################### Plot emission data donot chart ###################
function createDoughnutChart(label_set, data_set) {
    const doughnut1Ctx = document.getElementById('doughnut1Chart').getContext('2d');
    ...
    document.getElementById('doughnut1Chart').style.backgroundColor = 'rgba(255, 255, 255, 1)';
}

//################# Plot environmental data pie chart #################
function createPieChart(label_set, data_set) {
    const pie1Ctx = document.getElementById('envDataChart').getContext('2d');
    new Chart(pie1Ctx, {
        type: 'pie',
        data: {
            labels: label_set,
...
const getChartData = async (env_data_id) => {
    ...
    .then(results => {
        ...
        console.log("label_set", env_label);
        console.log("data_set", env_data);
        ...
        console.log("label_set2", emm_label);
        console.log("data_set2", emm_data);

        createPieChart(env_label, env_data);    //Environmental data pie chart
        createPie2Chart(emm_label, emm_data);    //Emmision data pie chart
        //createLineChart(env_label, env_data, emm_data);    //Variation between environmental and emission data
